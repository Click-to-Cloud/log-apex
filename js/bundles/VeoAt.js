...
var VeoAt = function (_Component) {
  _inherits(VeoAt, _Component);

  function VeoAt() {
    _classCallCheck(this, VeoAt);

    return _possibleConstructorReturn(this, (VeoAt.__proto__ || Object.getPrototypeOf(VeoAt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VeoAt, _indexSoy2.default);

exports.default = VeoAt;
...
exports.templates = exports.VeoAt = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VeoAt.
   * @public
   */

  goog.module('VeoAt.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VeoAt.render';
  }
...
_metalSoy2.default.register(VeoAt, templates);
exports.VeoAt = VeoAt;
