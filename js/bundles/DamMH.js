...
var DamMH = function (_Component) {
  _inherits(DamMH, _Component);

  function DamMH() {
    _classCallCheck(this, DamMH);

    return _possibleConstructorReturn(this, (DamMH.__proto__ || Object.getPrototypeOf(DamMH)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DamMH, _step_4Soy2.default);

exports.default = DamMH;
...
exports.templates = exports.DamMH = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DamMH.
   * @public
   */

  goog.module('DamMH.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DamMH.render';
  }
...
_metalSoy2.default.register(DamMH, templates);
exports.DamMH = DamMH;
