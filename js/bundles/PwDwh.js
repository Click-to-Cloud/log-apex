...
var PwDwh = function (_Component) {
  _inherits(PwDwh, _Component);

  function PwDwh() {
    _classCallCheck(this, PwDwh);

    return _possibleConstructorReturn(this, (PwDwh.__proto__ || Object.getPrototypeOf(PwDwh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PwDwh, _step_2Soy2.default);

exports.default = PwDwh;
...
exports.templates = exports.PwDwh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PwDwh.
   * @public
   */

  goog.module('PwDwh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PwDwh.render';
  }
...
_metalSoy2.default.register(PwDwh, templates);
exports.PwDwh = PwDwh;
