...
var uhvUw = function (_Component) {
  _inherits(uhvUw, _Component);

  function uhvUw() {
    _classCallCheck(this, uhvUw);

    return _possibleConstructorReturn(this, (uhvUw.__proto__ || Object.getPrototypeOf(uhvUw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uhvUw, _step_5Soy2.default);

exports.default = uhvUw;
...
exports.templates = exports.uhvUw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uhvUw.
   * @public
   */

  goog.module('uhvUw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uhvUw.render';
  }
...
_metalSoy2.default.register(uhvUw, templates);
exports.uhvUw = uhvUw;
